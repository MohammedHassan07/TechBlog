...
const insertData = (req, res) => {
    ...
    try {
        ...
        const myQuery = 'INSERT INTO Blogs (blogTitle, blogContent, ImgURL, smallPara, Authors) VALUES (?, ?, ?, ?, ?)';


        connection.query(myQuery, [blogTitle, blogContent, ImgURL, smallPara, authorName], (error, result) => {
